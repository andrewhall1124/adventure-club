...
export async function loader({params, request, context}) {
  const productHandle = 'slab-1l-cross-body-bag';
    ...
    <>
      <div className='mx-6 my-6 pt-2 my-shadow'>
        ...
        <div className='p-4 font-two'>
          Preorder the Slab 1L Hiking Bag now and enjoy free shipping by using the code EARLYADOPTER at checkout. Get ready to elevate your outdoor adventures with this durable and compact bag.
        </div>          
      </div>
